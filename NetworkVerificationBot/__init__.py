...
if ENV:
    ...
    PUBLIC_APPROVED_CHANNEL_USERNAME = Config.PUBLIC_APPROVED_CHANNEL_USERNAME
    VERIFICATION_CHANNEL_ID = Config.VERIFICATION_CHANNEL_ID
    PRIVATE_APPROVED_CHANNEL_ID = Config.PRIVATE_APPROVED_CHANNEL_ID
    PUBLIC_APPROVED_CHANNEL_ID = Config.PUBLIC_APPROVED_CHANNEL_ID
